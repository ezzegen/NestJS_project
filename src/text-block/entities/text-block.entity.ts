...
export class TextBlockEntity implements ICreationTextBlock  {
  ...
  @PrimaryGeneratedColumn({ type: 'int', primaryKeyConstraintName: 'pk_txt_block_id' })
  id: number;

  @ApiProperty({ example: 'promo-sale-text', description: 'Unique name for searching' })
  @Column({ length: 30, unique: true})
  searchKey: string;

  @ApiProperty({ example: 'April sales!', description: 'Title of text' })
