...
export class TextBlockController {
  ...
  @ApiOperation({
    summary: 'All text blocks or one if there is a query searchKey',
  })
  @ApiResponse({ status: 200 })
  @Get('/')
  getTextBlock(
    @Query('searchKey') searchKey: string | undefined = undefined,
  ): Promise<TextBlockEntity[] | TextBlockEntity> {
